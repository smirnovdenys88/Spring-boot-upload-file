 ...
 */
//TODO To display the video in the browser. Splits video into pieces of bytes.
public class MultipartFileSender {
    ...
    public static MultipartFileSender fromPaths(List<Path> path) {
    ...
    //TODO list paths
    private MultipartFileSender setFilepath(List<Path> filepaths) {
...
//        System.out.println(length);
        ...
        long lastModified = LocalDateTime.ofInstant(lastModifiedObj.toInstant(), ZoneId.of(ZoneOffset.systemDefault().getId()))
